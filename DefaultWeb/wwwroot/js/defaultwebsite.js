...
define('dws/model', ['dws/model-actions'], function (ModelActions) {
    ...
    var viewModel = {
        ...
        sources: ko.observableArray([]).extend({deferred: true}),
        ...
        commentTitle: ko.pureComputed(function () { return 'Author: ' + viewModel.comment.Author + 'Posted: ' + viewModel.comment.Datetime }, this),
...
function (Control, viewModel) {
    ...
    //$('#sources', document).on('load', function (e) {
    //    viewModel.sources().extend({ deferred: false });
    //    $('#sources-table tbody tr:first').addClass('active');
    //    if (viewModel.sources().length > 0) {
    //        $('#sources-table tbody tr:first').addClass('active');
    //        viewModel.source(viewModel.sources()[0]);
    //    }
