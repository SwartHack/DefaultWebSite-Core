 ...
 * Based on Bootstrap
*/
define("dws/model",["dws/model-actions"],function(){var n={file:ko.observable(""),files:ko.observableArray([]),data:ko.observable(""),dataType:ko.observable(""),target:ko.observable(""),error:function(n,t,i){alert(i+"\n"+t)},waiting:ko.observable(!1),sources:ko.observableArray([]),source:ko.observable(""),sourcesCount:ko.pureComputed(function(){return"Records: "+n.sources().length},this),addSource:function(t){n.sources.unshift(t)},removeSource:function(t){n.sources.remove(t)},sourceAdded:function(n,t,i){var u=$(n),r=$(i);r.hide().fadeIn("slow");console.log("Source afterAdd... ")},comments:ko.observableArray([]),comment:ko.observable(""),commentsCount:function(){return"Records: "+this.comments.length},addComment:function(t){n.comments.unshift(t)},removeComment:function(t){n.comments.remove(t)},commentAdded:function(n){var t=$(n);t.hide().fadeIn("slow");console.log("Comment afterAdd... ")},canAddComment:function(){return this.source===null?!1:!0}};return n.data.subscribe(function(t){n.target()?$(n.target()).html(t):$(t).dialog()}),n.source.subscribe(function(t){var i=n.sources.indexOf(t);$($("#sources-table tbody tr")[i]).addClass("active").siblings().removeClass("active");t.comments&&n.comments(t.comments);console.log("source subscribe:"+t)}),n.waiting.subscribe(function(n){n}),n});define("dws/model-actions",function(){});define("dws/dispatcher",["dws/model"],function(n){function t(n){var t=new XMLHttpRequest;t.onload=function(){this.readyState==4&&this.status==200?alert(this.responseText):alert("Message not found!"+this.readyState+":"+this.status+"-"+this.responseText)};t.open("GET",n,!0);t.send()}function i(t){$.ajax(t).done(function(t){n.data(t)}).fail(function(t,i){n.aborted(t,i,this.responseText)}).always(function(){})}function r(n,t){$.ajax(n).done(function(n){t.resolve(n)}).fail(function(n,i){t.reject(this.responseText+"\n"+i)}).always(function(){})}return{xhrRequest:t,ajaxRequest:i,ajaxRequestDefer:r}});define("dws/actions",["dws/controller"],function(n){return $(document).ready(function(){$("#rundown").on("click",function(t){var i,r;t.preventDefault();i=$(this);$("li.rundown").removeClass("selected");i.addClass("selected");r={url:"/Home/GetRundown?viewname="+i.attr("data-target-view"),cache:!1,dataType:"html"};n.sendMessage(r,"#target-area")});$(".nav-link").on("click",function(t){t.preventDefault();var i=$(this);n.sendMessageDefer(i)});$(document).on("click","#sand-link",function(t){t.preventDefault();var i=$(t.target);$("#sand-link").removeClass("active");i.addClass("active");n.sendMessageDefer(i)});$(document).on("click","#btn-blog",function(n){n.preventDefault();$("#blog-text").toggleClass("hidden");$("#blog-content").toggleClass("hidden")});$(document).on("shown.bs.collapse","#doc-resume",function(n){n.preventDefault();$("#target-area").animate({scrollTop:$(this).offset().top},800);$('[data-target="#doc-resume"] h4 i').switchClass("fa-eye","fa-eye-slash");$("#doc-cv").hasClass("show")&&$("#doc-cv").removeClass("show")});$(document).on("hide.bs.collapse","#doc-resume",function(){$('[data-target="#doc-resume"] h4 i').switchClass("fa-eye-slash","fa-eye")});$(document).on("hide.shown.bs.collapse","#doc-cv",function(n){n.preventDefault();$("#target-area").animate({scrollTop:$(this).offset().top},800);$('[data-target="#doc-cv"] button h4 i').switchClass("fa-eye","fa-eye-slash");$("#doc-resume").hasClass("show")&&$("#doc-resume").removeClass("show")});$(document).on("bs.collapse","#doc-cv",function(){$('[data-target="#doc-cv"] h4 i').switchClass("fa-eye-slash","fa-eye")});$("#source-modal").on("hidden.bs.modal",function(){n.sendMessage({url:"/Sources/Main",cache:!1},"#sandbox-area")});$("input:checkbox").change(function(){});$("div#footer-scroll").endlessScroll({width:"100%",height:"20px",steps:-2,speed:40,mousestop:!0})}),{}});define("dws/sandbox",["dws/model"],function(n){function r(n){n?t.observe(document.getElementById("sandbox-area"),i):t.disconnect()}var i={attributes:!0,childList:!0,characterData:!0},t=new MutationObserver(function(t){t.forEach(function(t){if(t.addedNodes.length>0){var i=t.addedNodes,r=$(i).find("[data-bind]");i.each(function(){var t=$(this);ko.dataFor(t[0])||ko.applyBindings(n,t[0])})}})});return{observe:r}});define("dws/controller",["dws/model","dws/dispatcher"],function(n,t){function u(){n.target(null);t.ajaxRequest({url:"/Home/Talk?message=Hello Server",cache:!1,dataType:"html"})}function f(n){$(n).is(":visible")||(i(),$(n).show())}function i(){$(".content-area").hide()}function r(n){var t;return t=n.attr("data-target-controller")&&n.attr("data-target-action")?"/"+n.attr("data-target-controller")+"/"+n.attr("data-target-action"):"/Home/GetView",n.attr("data-target-id")&&(t=t+"?id="+n.attr("data-target-id")),t}function e(i,r){n.target(r);t.ajaxRequest(i)}function o(i){var f=i.attr("data-target"),e=r(i),o={url:e,cache:!1},u=new $.Deferred;u.done(function(t){t?n.data(t):alert("invalid data from server")}).fail(function(n){alert(n)});n.target(f);t.ajaxRequestDefer(o,u)}function s(){ko.applyBindings(n)}return{initKO:s,test:u,sendMessage:e,sendMessageDefer:o,showContentArea:f,hideAllContent:i,parseNavUrl:r}});define("dws/comments",["dws/controller","dws/model"],function(n,t){function i(){t.sources([]);$.ajax({url:"/Comments/GetSources",cache:!1,dataType:"json"}).done(function(n){t.sources(n.sources);n.sources.length>0&&t.source(n.sources[0])}).fail(function(n,i){t.aborted(n,i,this.responseText)}).always(function(){})}$(document).on("submit","form#new-source",function(n){var i,r,u;n.preventDefault();i=$(this);r=$(".submit",i);r.attr("disabled",!0);u=i.serializeArray();i.hide();$.ajax({url:"/Comments/CreateSource",dataType:"json",type:"POST",data:u}).done(function(n){n.source||alert("Invalid response from server...");t.addSource(n.Source)}).fail(function(){alert("error")}).alway(function(){$("#source-modal").modal("hide")})});$(document).on("submit","form#new-comment",function(n){var i,u,r,f;n.preventDefault();i=$(this);u=$(".submit",i);u.attr("disabled",!0);r=i.serializeArray();f=r.findIndex(n=>n.name=="SourceId");r[f]=t.source.id;i.hide();$.ajax({url:"/Comments/CreateComment",dataType:"json",type:"POST",data:r}).done(function(n){n.Comment||alert("Invalid response from server...");t.addComment(n.Comment)}).fail(function(){alert("error")}).alway(function(){$("#source-modal").modal("hide")})});$(document).on("click","div#source-block table tbody tr",function(n){var i=$(n.target),r=i.attr("id"),u=t.sources(n=>n.id==r);t.source(u)});return{GetSources:i}});require(["dws/actions"]);require(["dws/comments"]);require(["dws/sandbox"]);require(["dws/model-actions"]);require(["dws/controller"]),function(n){$(document).ready(function(){n.initKO()})};