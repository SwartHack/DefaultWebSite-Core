 ...
 * Based on Bootstrap
*/
define("dws/komodel",function(){var n={file:ko.observable(""),files:ko.observableArray(),data:ko.observable(""),dataType:ko.observable(""),target:ko.observable(""),error:ko.observable(function(n,t,i){alert(i+"\n"+t)}),waitEffects:ko.observable(!1)};return n.data.subscribe(function(t){n.target()?$(viewmodel.target()).html(t):$(t).dialog()}),n});define("dws/dispatcher",["dws/komodel"],function(n){function t(n){var t=new XMLHttpRequest;t.onload=function(){this.readyState==4&&this.status==200?alert(this.responseText):alert("Message not found!"+this.readyState+":"+this.status+"-"+this.responseText)};t.open("GET",n,!0);t.send()}function i(t){$.ajax(t).done(function(t){n.data(t)}).fail(function(t,i){n.aborted(t,i,this.responseText)}).always(function(){})}return{xhrRequest:t,ajaxRequest:i}});define("dws/actions",["dws/controller"],function(n){function i(n){$(n).is(":visible")||(t(),$(n).show())}function t(){$(".content-area").hide()}return $(document).ready(function(){$(document).on("shown.bs.collapse","#doc-resume",function(){$("#target-area").animate({scrollTop:$(this).offset().top},800);$("#doc-cv").hasClass("in")&&($("#doc-cv").removeClass("in"),$('[data-target="#doc-cv"]').toggleClass("collapsed"))});$(document).on("shown.bs.collapse","#doc-cv",function(){$("#target-area").animate({scrollTop:$(this).offset().top},800);$("#doc-resume").hasClass("in")&&($("#doc-resume").removeClass("in"),$('[data-target="#doc-resume"]').toggleClass("collapsed"))});$("#rundown").on("click",function(t){var i,r;t.preventDefault();i=$(this);$("li.rundown").removeClass("selected");i.addClass("selected");r={url:"/Home/GetRundown?viewname="+i.attr("data-target-view"),cache:!1,dataType:"html"};n.sendMessage(r,"#target-area")});$(document).on("click",".nav-link",function(n){n.preventDefault();var i="/Home/GetView?viewname="+$link.attr("data-target-view"),t=new $.Deferred;t.done($("#target-area").html(data)).fail(function(n){n!=="aborted"&&alert("Error processing request")}).always(function(){});Dispatch.ajaxRequestDefer(i,!1,"html",t)});$(document).on("click","#btn-blog",function(n){n.preventDefault();$("#blog-text").toggleClass("hidden");$("#blog-content").toggleClass("hidden")});$("input:checkbox").change(function(){});$("div#footer-scroll").endlessScroll({width:"100%",height:"20px",steps:-2,speed:40,mousestop:!0})}),{showContentArea:i,hideAllContent:t}});define("dws/sandbox",function(){});define("dws/controller",["dws/komodel","dws/dispatcher"],function(n,t){function i(){n.target(null);t.ajaxRequest({url:"/Home/Talk?message=Hello Server",cache:!1,dataType:"html"})}function r(i,r){n.target(r);t.ajaxRequest(i)}function u(){ko.applyBindings(n)}return{initKO:u,test:i,sendMessage:r}});require(["dws/actions"]);require(["dws/controller"],function(n){$(document).ready(function(){n.initKO()})});